...
public class GlobalExceptionHanlder {
    ...
    public ResponseEntity<ApiResponse<Object>> handleMyAppException(Exception ex) {
        ApiResponse<Object> res = new ApiResponse<Object>();
        res.setStatusCode(HttpStatus.BAD_REQUEST.value());
    ...
    public ResponseEntity<ApiResponse<Object>> handleNotValidException(MethodArgumentNotValidException ex) {
